    ...
    return [
        {
            ...
            "content": (
                ...
                "Spawn sub-entities when the entity is a large organization or institution where "
                ...
                "For example: a tech company might spawn an executive, a legal team, and a procurement team. "
                "Do NOT spawn sub-entities for: individual people, simple institutions, or entities "
                "whose internal dynamics don't materially affect the scenario. "
    ...
    return [
        {
            ...
            "content": (
                ...
                "Describe your assessment of the situation and the concrete actions or decisions "
                "you are taking right now. Be specific and grounded — name real choices, not generalities. "
    ...
    return [
        {
            ...
            "content": (
                ...
                "Describe how entities acted, how they interacted, and what concretely changed. "
